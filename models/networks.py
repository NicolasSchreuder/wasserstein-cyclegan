...
def define_D(input_nc, ndf, which_model_netD,
    ...
    if which_model_netD == 'basic':
        ...
        netD = DCGAN_D(input_nc, ndf, ngpu=-1, isize=32, n_extra_layers=0)
    else:
...
class DCGAN_D(nn.Module):
    ...
    def forward(self, input):
        # If input is tensor and multiple gpu -> parallelize
        ...
        #print("Output of DCGAN size : {}".format(output.size()))

        #output = output.mean(0) # mean
        #return output.view(1) # returns scalar
        return output
